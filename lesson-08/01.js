...
const petShop = document.querySelector(".pet-shop"); // div со значками
const cartList = document.getElementById("cart-list"); // ul пустая
const messageBox = document.getElementById("message-box"); // сообщение под кнопкой
const clearCartButton = document.getElementById("clear-cart-button"); // button очистить корзину
